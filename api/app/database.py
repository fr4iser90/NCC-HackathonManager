...
if os.getenv("PYTEST_CURRENT_TEST") and os.getenv("DB_HOST") in ["db", "prod-db-host", "production-db-host"]:
    raise RuntimeError("Tests dürfen nicht gegen die Produktionsdatenbank laufen! Bitte .env.test korrekt konfigurieren.")
