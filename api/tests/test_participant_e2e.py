...
def test_participant_permissions_and_deadlines():
    ...
    if r.json():
        ...
        if r2.json():
            ...
            score_payload = {"project_id": project_id, "criteria_id": criterion_id, "score": 5, "notes": "Participant darf nicht bewerten"}
    ...
    if r.json():
        ...
        r2 = httpx.put(f"{BASE_URL}/projects/{project_id}", headers=headers, json=update)
