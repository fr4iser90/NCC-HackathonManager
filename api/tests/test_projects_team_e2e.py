...
def test_admin_crud_project_e2e(admin_user_data):
    ...
    # Team anlegen
    team_data = {
        "name": f"E2E Admin Team {unique}",
        "description": "E2E Admin Team",
    ...
    update_data = {
        "name": "E2E Admin Team Project Updated",
...
def test_user_crud_project_e2e(admin_user_data):
    ...
    # Bearbeiten
    update_data = {
        "name": "E2E User Team Project Updated",
        "description": "Updated by user",
    }
    r = httpx.put(
        f"{BASE_URL}/projects/{team_project_id}", json=update_data, headers=headers
    )
    ...
    foreign_team_data = {
        "name": f"E2E Foreign Team {unique}",
...
def test_team_project_forbidden_when_hackathon_not_active(admin_user_data):
    ...
    # Create team
    team_data = {
        "name": f"Forbidden Team {unique}",
        "description": "Forbidden Team",
        "hackathon_id": hackathon_id,
    }
    r = httpx.post(f"{BASE_URL}/teams/", json=team_data, headers=headers)
    assert r.status_code == 201
