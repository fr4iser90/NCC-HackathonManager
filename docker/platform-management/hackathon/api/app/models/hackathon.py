...
class Hackathon(Base):
    ...
    mode: Mapped[HackathonMode] = mapped_column(SQLEnum(HackathonMode, name="hackathon_mode_enum", create_type=False), nullable=False, default=HackathonMode.SOLO_PRIMARY)
